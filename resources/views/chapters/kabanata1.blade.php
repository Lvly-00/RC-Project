    ...
    <div class="page-content">
        ...
        <div class="words">
            ...
            <p>1 Sa isang madilim, gubat na
                ...
                dumalaw sa loob na
                <span class="hoverable" data-word="Lubhang" data-audio="path/to/audio/lubhang.mp3"
        ...
        <div class="words">
            ...
            <p>2 Malalaking kahoy ang inihahandog,
                pawang
                <span class="hoverable" data-word="Dalamhati" data-audio="path/to/audio/dalamhati.mp3"
                ...
                <span class="hoverable" data-word="Kahapis" data-audio="path/to/audio/kahapis.mp3"
                    ...
                    data-antonyms="Kaligayahan, kasiglahan." data-synonyms="Pagluha, lungkot.">kahapis</span>a't
                lungkot;
                huni pa ng ibon ay
                <span class="hoverable" data-word="Nakalulunos" data-audio="path/to/audio/nakalulunos.mp3"
                    ...
                    data-antonyms="Nakakatawa, nakakaaliw." data-synonyms="Nakakalungkot, nakakaawa.">nakalulunos</span>
                sa
        ...
        <div class="words">
            <p>3 Tanang mga
                <span class="hoverable" data-word="Baging" data-audio="path/to/audio/mapanglaw.mp3"
                    data-definition-tag="Uri ng halamang dumadagan at tumataas."
                    data-definition-eng="Vine, creeping plant." data-example=""
                    data-antonyms="Punong matikas, tangkay na tuwid." data-synonyms="Halaman, puno.">baging</span> na
                namimilipit
        ...
        <div class="words">
            <p> 5 Karamiha'y Sipres at Higerang
                <span class="hoverable" data-word="Kutad" data-audio="path/to/audio/mapanglaw.mp3"
                    ...
                    data-antonyms="Malambot, mapurol." data-synonyms="Matigas, matalim.">kutad</span> na ang lihim niyon
                ay
                nakakasindak;
        ...
        <div class="words">
            <p> 6 Ang mga hayop pang dito'y gumagala,
                ...
                <span class="hoverable" data-word="Ganid" data-audio="path/to/audio/mapanglaw.mp3"
                    ...
                    data-example="" data-antonyms="Mapagbigay, bukas-palad."
                    data-synonyms="Matakaw, sakim.">ganid</span> na
                nagsisila
        ...
        <div class="words">
            <p>7 Ito'y gubat manding sa pinto'y malapit
                ...
                <span class="hoverable" data-word="Reyno" data-audio="path/to/audio/mapanglaw.mp3"
                    ...
                    data-example="s" data-antonyms=" Republika, estado."
                    data-synonyms="Kaharian, pamahalaan.">reyno</span>
                ni Plutong masungit;
