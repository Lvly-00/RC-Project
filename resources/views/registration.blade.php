        ...
        <div class="form-container">
            <form class="form" action="{{ route('postsignup') }}" method="POST">
                ...
                <div class="field">
                    ...
                    <input autocomplete="off" placeholder="Username" class="input-field" type="text" name="name">
                    @if ($errors->has('name'))
                ...
                <div class="field">
                    <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                        <path d="M2 4a2 2 0 1 1 4 0v1h8a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2V4zm4 1V4a1 1 0 0 0-2 0v1h2z"></path>
                    </svg>
