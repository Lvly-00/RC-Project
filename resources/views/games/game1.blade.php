...
<body>
    ...
    <div id="result-container" class="hidden">
        <p class="result"></p>
        <a href="{{ route('chapters.show', ['number' => 2]) }}"
        ...
        <button id="next-chapter" class="hidden">Next Chapter</button>    </a>
    </div>
    ...
    <script>
        ...
        function submitQuiz() {
            ...
            resultText.innerText = `You scored ${score} out of ${questionsPerChapter}.`;
